            ...
            <div class="flex flex-row justify-center mb-2 md:justify-start md:mb-0">
                <div class="relative h-10">
                    <select wire:model.live="setUp.footer.perPage"
                        class="block px-3 py-2 pr-8 leading-tight border rounded appearance-none pg-select bg-pg-primary-50 border-pg-primary-300 text-pg-primary-700 focus:outline-none focus:bg-white focus:border-pg-primary-500 dark:bg-pg-primary-700 dark:text-pg-primary-200 dark:placeholder-pg-primary-200 dark:border-pg-primary-600">
                    ...
                    <div
                        class="absolute inset-y-0 right-0 flex items-center px-3 pointer-events-none text-pg-primary-700 dark:text-pg-primary-300">
