...
<div class="w-full py-36 backdrop-blur-md bg-white/30">

        <div class="flex text-3xl px-auto text-center  lg:text-5xl mb-10  items-center justify-center "> SAN JUAN MUNICIPAL COUNCIL</div>
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-8 gap-4 p-4">
        ...
        <div class="group cursor-pointer relative">
        <img
        src="{{asset('storage/images/back-sjmc.webp')}}"
        alt="Image 1"
        class="w-full h-48 object-cover rounded-lg transition-transform transform scale-100 group-hover:scale-105"
        />
        <div class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
