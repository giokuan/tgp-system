            ...
            <div class="mb-6">
                ...
                <div class="flex justify-center">
                    <div class="w-14 h-14 rounded-full bg-gray-300 border-2 border-white mt-2">
                        <img src="{{ Auth::user()->profile_photo_url }}" class="rounded-full w-auto" />
                    </div>
                </div>
                <!--End logo -->
                <!--Start NavItem -->
        ...
        {{-- <div class="flex flex-col flex-1 w-full overflow-y-auto">
            ...
            <main class="relative z-0 flex-1 pb-8 px-6 bg-white">
                <div class="grid pb-10  mt-4 ">
                    ...
                    <div
                        class="grid grid-cols-1 gap-2 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 mt-3">
